...
namespace DormitoryManagement.BusinessLogicLayer
{
    ...
    public class BLL_TienDien
    {
        ...
        {
            return dbs.ElectricityAndWaterBills.ToList();
        }
        public bool InsertTienDien(ref string err, string mahoadon, string maphong, DateTime ngaylap, int sodientieuthu, int sonuoctieuthu, string trangthai)
        {
            ...
            try
            {
                ...
                dbs.ElectricityAndWaterBills.Add(dnsd);
                dbs.SaveChanges();
                flag = true;
            }
            catch (SqlException)
        ...
        public bool UpdateTienDien(ref string err, string mahoadon, string maphong, DateTime ngaylap, int sodientieuthu, int sonuoctieuthu, string trangthai)
        {
            ...
            try
            {
                var dnsd = dbs.ElectricityAndWaterBills.Find(mahoadon);
                if (dnsd != null)
                {
        ...
        public bool DeleteTienDien(ref string err, string mahoadon)
        {
            ...
            if (dnsd != null)
            {
                dbs.ElectricityAndWaterBills.Remove(dnsd);
                dbs.SaveChanges();
                flag = true;
            }
            return flag;
        ...
        {
            return dbs.ElectricityAndWaterBills.Where(x=>x.TrangThai=="Chưa thanh toán").ToList();
        }
        ...
        {
            var hoadon = dbs.ElectricityAndWaterBills.Where(x => x.MaHoaDon == mahoadon).FirstOrDefault();
